...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.bakeryNameRefresh=function()
		{
			...
			if (!App && typeof Game.OpenSesame==='function' && name.indexOf('saysopensesame',name.length-('saysopensesame').length)>0 && !Game.sesame) Game.OpenSesame();
		...
		*/
		...
		Game.ready=1;
		Game.bakeryNameSet('Dev saysopensesame');
